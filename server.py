...
sys_prompt=ChatPromptTemplate.from_messages([
    ('system', 'tell me a joke for topic {topic}.'),
    ("user" , "tell me a clean, short joke"),
])
...
#outputparser
sys_parser=StrOutputParser()

#LCEL chain
chain= sys_prompt|model|sys_parser
...
# model = ChatGoogleGenerativeAI(
#     model="gemini-1.5-flash",
#     google_api_key="AIzaSyC0zPxlocYPJU5SHp5EGQ6DyJKgCDiE9vo"
#     # os.environ.get("GOOGLE_API_KEY")  # Explicitly pass the API key
# )
